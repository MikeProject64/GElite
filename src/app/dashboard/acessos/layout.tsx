...
export default function AcessosLayout({ children }: { children: React.ReactNode }) {
  ...
  const currentTab = TABS_DATA
    ...
    .find(tab => pathname.startsWith(tab.path))?.path || TABS_DATA[1].path;
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Modal de convite pode ser implementado aqui se necessário */}
    </div>
  );
} 